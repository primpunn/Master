...
class MyRobot:
    ...
    def __init__(self, ur_5):
        ...
        #define the movegroup for the robotic 
        #Replace this value with your robots planning group name that you had set in Moveit Setup Assistant
        self._planning_group = ur_5
